...
bot.on("message", async message => {	
    ...
    if (command === "gen") {	
        if(message.channel.id !== "828982360133337148") return message.channel.send("This command can be runned only in <#828982360133337148> channel")	
            ...
            let account = JSON.parse(data)	
                ...
                const embed = {	
                    ...
                    footer: {	
                        ...
                        text: "Accounts Has Been Generated! Check Your Dms."	
                    },	
                    thumbnail: {	
                        url:	
...
bot.login("ODIwNDgyODUzOTI1MjkwMDE1.YE10NA._nb4ZaFiSZp_i9-1KipYNVky_24");	
